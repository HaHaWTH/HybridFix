...
public class EmptyNetHandler extends NetHandlerPlayServer {
    public EmptyNetHandler(EntityPlayerMP playerIn) {
        super(FMLCommonHandler.instance().getMinecraftServerInstance(), new EmptyNetworkManager(EnumPacketDirection.CLIENTBOUND), playerIn);
